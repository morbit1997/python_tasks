    ...
    with open(config_filename) as f:
        for line in f:
            ...
            if line.startswith("!"):
                ...
                continue
            if line.startswith("interface") or line.startswith("line"):
                dict_status = line.rstrip()
                my_dict[line.rstrip()] = []
                continue
            if dict_status in my_dict.keys() and line.rstrip() != "end":
                my_dict[dict_status].append(line.strip())
                continue
            else:            
                my_dict[line.rstrip()] = []
